...
function program11(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.exampleResponse, {hash:{},inverse:self.program(14, program14, data),fn:self.program(12, program12, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
function program12(depth0,data) {
  ...
  return "\n                        <input class='submit' name='commit' type='button' value='Show Sample Response' />\n                        ";
  }
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.addParameter = function(param) {
      var paramView;
      if (this.model.exampleRequest) {
        paramView = new ParameterView({
          model: param,
          tagName: 'tr',
          readOnly: this.model.isReadOnly,
          exampleRequest: this.model.exampleRequest.params[param.name]
        });
      } else {
        paramView = new ParameterView({
          model: param,
    ...
    OperationView.prototype.submitOperation = function(e) {
      var bodyParam, consumes, data, error_free, form, headerParams, invocationUrl, isFileUpload, isFormPost, map, o, obj, param, paramContentTypeField, responseContentTypeField, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      if (e != null) {
        e.preventDefault();
      }
      ...
      if (error_free) {
        ...
        if (this.model.exampleResponse) {
          data = {
            responseText: this.model.exampleResponse.body,
            status: this.model.exampleResponse.code,
            getAllResponseHeaders: function() {
              return JSON.stringify(_this.model.exampleResponse.headers, null, 2);
            }
          };
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.render = function() {
      ...
      if (!this.model.defaultValue) {
        this.model.defaultValue = this.options.exampleRequest;
      }
      template = this.template();
      $(this.el).html(template(this.model));
      signatureModel = {
